export const creatureMapData = [
    ...
    },
    {
        ...
        migration: {
            route: [
                ...
                [110.0, -7.5], [115.0, -8.0], [119.45, -8.55]
            ],
            direction: 'east',
            timing: [
    ...
    },
    {
        ...
        migration: {
            route: [
                ...
                [-10.0, 35.5], [-5.35, 35.9], [5.0, 37.0],
                [15.0, 37.5], [20.87, 37.73]
            ],
            direction: 'east',
            timing: [
    ...
    },
    {
        ...
        migration: {
            route: [
                [113.65, -22.67], [115.0, -18.0], [117.0, -13.0],
                [119.5, -10.0], [121.0, -8.5], [122.5, -7.0],
                [124.0, -6.0], [125.0, -4.0], [126.5, -2.0],
                [126.0, 1.0], [125.5, 4.0], [124.5, 7.0],
                [123.42, 9.56]
            ],
            direction: 'north',
            timing: [
    ...
    },
    {
        ...
        migration: {
            route: [
                ...
                [-48.0, -35.0], [-45.0, -30.0], [-40.0, -20.0],
                [-35.0, -10.0], [-30.0, 0.0], [-28.0, 10.0],
    ...
    },
    {
        ...
        migration: {
            route: [
                ...
                [-55.0, -45.0], [-52.0, -35.0], [-55.0, -25.0],
                [-60.0, -18.0], [-65.0, -12.0], [-69.7, 20.54],
                [-70.0, 25.0], [-72.0, 30.0], [-71.5, 35.0],
                [-70.5, 40.0], [-70.25, 42.33]
            ],
            direction: 'north',
            timing: [
